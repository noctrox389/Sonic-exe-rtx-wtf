...
function onCreate()
    makeLuaSprite('MajinCount1', 'majin-count/three', 250, 50)
    setScrollFactor('MajinCount1', 0, 0)
    setObjectCamera('MajinCount1', 'other')

    makeLuaSprite('MajinCount2', 'majin-count/two', 250, 50)
    setScrollFactor('MajinCount2', 0, 0)
    setObjectCamera('MajinCount2', 'other')


    makeLuaSprite('MajinCount3', 'majin-count/one', 250, 50)
    setScrollFactor('MajinCount3', 0, 0)
    setObjectCamera('MajinCount3', 'other')

    makeLuaSprite('MajinCount4', 'majin-count/gofun', 250, 50)
